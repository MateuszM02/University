namespace oop4
{
    ...
    public interface IShapeFactoryWorker
    {
        ...
        public IShape Create(params object[] parameter);
    }

    // 1. Kwadrat ---------------------------------------------------------------------------------

    public class Square(double edgeSize) : IShape
    {
        private double edgeSize = edgeSize;
